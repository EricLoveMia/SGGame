...
public class Map {
	...
	// 城市
	public int[] city = {1,2,3,4,5,6,11,12,13,14,15,16,21,22,23,
				  24,25,26,33,34,35,36,37,38,41,42,43,44,45,46,
				  51,52,53,54,55,56,59,60,61,62,63,64,67,68,69,70,71,72,
				  77,78,79,80,81,82,85,86,87,90,91,92,93,94,95,96,97,98};
    ...
    public void showRLine(int start, int end, int playerPos1, int playerPos2){
    	int h = 1;
    	for(int i = start; i<= end; i++){
    	   System.out.print(getGraph(map[100-h], i,playerPos1, playerPos2));
    ...
    public void showMap(int playerPos1, int playerPos2){
    	showLine1(0, 24, playerPos1, playerPos2);   //显示地图第一行
    	System.out.println();                     //换行
    	showRLine(25,49, playerPos1, playerPos2);  //显示地图竖行
     	showLine2(50,74, playerPos1, playerPos2); //显示地图第二行
    }  
